...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Simulation1.0.0/ && (cd `dirname .tmp/Simulation1.0.0` && $(TAR) Simulation1.0.0.tar Simulation1.0.0 && $(COMPRESS) Simulation1.0.0.tar) && $(MOVE) `dirname .tmp/Simulation1.0.0`/Simulation1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Simulation1.0.0
