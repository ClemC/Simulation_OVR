...
# Generated by qmake (2.01a) (Qt 4.8.6) on: mar. oct. 14 16:15:43 2014
# Project:  Simulation.pro
# Template: app
# Command: /usr/lib/i386-linux-gnu/qt4/bin/qmake -o Makefile Simulation.pro
#############################################################################
...
CXXFLAGS      = -pipe -Ofast -Wno-deprecated -O2 -Wall -W $(DEFINES)
...
Makefile: Simulation.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/Simulation1.0.0 || $(MKDIR) .tmp/Simulation1.0.0 
